...
public class SecurityUser extends User implements UserDetails{
	...
	public SecurityUser(Long id, String userName, String password, String phone, Date createTime, Date lastLoginTime,List<Role> roles) {
		this.id = id;
		...
		System.err.println(grantedAuthoritys);
